(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__slider")) new swiper_core_Swiper(".hero__slider", {
            ...
            navigation: {
                prevEl: ".button-slider__hero-swiper-button-prev",
                nextEl: ".button-slider__hero-swiper-button-next"
            },
            on: {
                slideChange: function() {
                    const currentSlideNumber = document.querySelector(".button-slider__number");
                    const currentSlideIndex = this.realIndex + 1;
                    currentSlideNumber.textContent = currentSlideIndex < 10 ? `0${currentSlideIndex}` : currentSlideIndex;
                },
                init() {
        ...
        if (document.querySelector(".color__slider-smoll") && document.querySelector(".color__slider-big")) {
            let swiperSmoll = new swiper_core_Swiper(".color__slider-smoll", {
                modules: [ Navigation, Autoplay, Thumb ],
                loop: true,
                spaceBetween: 24,
                slidesPerView: 4,
            ...
            new swiper_core_Swiper(".color__slider-big", {
                modules: [ Navigation, Autoplay, Thumb ],
                loop: true,
                spaceBetween: 10,
                thumbs: {
...
***************************************************************************** */
    ...
    const str = "workssee.how.it.";
    const textCircle = document.querySelector(".circle__text");
    window.onload = function() {
        for (let i = 0; i < str.length; i++) {
            ...
            console.log(str[i]);
            span.style.transform = `rotate(${23 * i}deg)`;
        }
    };
    document.querySelectorAll(".features-hero__card").forEach((card => {
        card.addEventListener("mouseenter", (() => {
            card.closest(".features-hero__items").classList.add("paused");
        }));
        card.addEventListener("mouseleave", (() => {
            card.closest(".features-hero__items").classList.remove("paused");
        }));
    }));
    window["FLS"] = true;
    addLoadedClass();
